...
function Drawer() {
  return (
    <div className="drawer container-fluid">
      ...
      <p>Here you can create and solve maze</p>
      <hr />
      {/* TODO create router */}
